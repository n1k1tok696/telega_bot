...
class ControllerGetdata extends Controller
{
  ...
  public function income() {
    $incomeData = Pay::where('type', '=', 'income')->get();
    return view('user.income', ['incomeData' => $incomeData]);
  }

  public function expense() {
    $expenseData = Pay::where('type', '=', 'expense')->get();
    return view('user.expense', ['expenseData' => $expenseData]);
  }
}
